...
<div class="isolate bg-base-100 px-6 py-24 sm:py-32 lg:px-8">
  ...
  <div class="hero-content text-center">
    <div class="max-w-md">
      ...
      <div>
        <input bind:value={name} type="text" id="name-input" placeholder="Enter your name" class="input input-bordered lg:input-lg md:input-md w-full max-w-xs" />

        <button on:click={saveName} class="btn btn-xs lg:btn-lg sm:mt-3 text-white ${"modal-action"}">Get Started</button>
...
<div class="modal modal-bottom sm:modal-middle">
  <div class="modal-box ">
    ...
    <p class="py-4">
      ...
      which means that we do not collect any personal information or data from our users. We believe
      that user privacy is of utmost importance, and we are committed to providing a safe and secure
      browsing experience. Rest assured that your visit to our website is completely confidential
      and anonymous.
    </p>
